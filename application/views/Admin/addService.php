                    ...
                    <div class="border-left-primary">
                        <div class="container">
                            <form method="POST" enctype="multipart/form-data"
                                action="<?php echo base_url() . 'service/newservice' ?>" class="needs-validation">
                                <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="serviceName"
                                                    placeholder="service Name" name="serviceName" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="servicedescription">service description</label>
                                                <input type="text" class="form-control" id="servicedescription"
                                                    placeholder="service description" name="servicedescription"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-row">
