                    ...
                    <div class="border-left-primary">
                        <div class="container">
                            <form method="POST" enctype="multipart/form-data"
                                action="<?php echo base_url() . 'banner/editBanner/'.$Banner['id'] ?>"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="bannerName"
                                                    placeholder="Banner Name" name="bannerName"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="bannerTitle"
                                                    placeholder="Banner Title" value=<?php echo $Banner['title'] ?>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <img style="max-width: 180px; border-radius: 5px;" id="image"
                                                    src="<?php echo base_url() . 'upload/banners/'.$Banner['image'] ?>"
                                                    alt="your image" />
                                                <input style="max-width: 180px; border-radius: 5px; max-height: 50px"
                                                    ...
                                                    value="<?php echo base_url() . 'upload/banners/'.$Banner['image']; ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
